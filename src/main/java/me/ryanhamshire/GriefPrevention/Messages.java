...
public enum Messages
{
    ...
    ConvertSubdivisionSelectFirst("Right-click a corner of the subdivision with your golden shovel to select it, then run that command again."),
    ConvertSubdivisionAlreadyAdmin("This subdivision is already an administrative subdivision."),
    ConvertSubdivisionAlreadyBasic("This subdivision is already a normal subdivision."),
    ConvertSubdivisionAdminSuccess("Subdivision converted to an administrative subdivision.  Its owner can no longer resize it, manage trust in it, or abandon the claim around it."),
    ConvertSubdivisionBasicSuccess("Administrative subdivision returned to a normal subdivision."),
    AdminSubdivisionRestricted("That subdivision is administered by staff.  Talk to staff if you need it changed."),
    AbandonBlockedAdminSubdivision("You can't abandon this claim: it contains an administrator's subdivision.  Talk to staff."),
    ...
    _3DAdminClaimsMode("3D Administrative claims mode active.  Any claims created will be free, height-limited, and editable by other administrators."),
    ...
    ShapedSubdivisionMode("Shaped subdivision mode. Right-click inside one of your claims to place corners, then click your first corner again to close the subdivision. Click an existing shaped subdivision's boundary to reshape it. Use /basicclaims to exit."),
    ShapedSubClaimsDisabled("Shaped subdivisions are disabled on this server."),
    ScrollResizeStart("Scroll resize: look at a side, then scroll up to push it away from you or down to pull it toward you. Right-click to apply; left-click or drop (Q) to cancel."),
    ScrollResizeStartCorner("Scroll resize: look along a side at the corner you selected, then scroll up to push it away from you or down to pull it toward you. Right-click to apply; left-click or drop (Q) to cancel."),
    ScrollResizeNeedTool("Hold your claim tool to use scroll resize."),
    ScrollResizeNoClaim("Stand in a claim, or right-click one of its corners with your claim tool, then run /scrollresize."),
    ScrollResizeSize("{0} x {1}", "0: width; 1: length"),
    ScrollResizeSize3D("{0} x {1} x {2}", "0: width; 1: length; 2: height"),
    ScrollResizeSizeShaped("{0} blocks", "0: area"),
    ScrollResizeBlocksLeft("{0} ({1} claim blocks left)", "0: size; 1: remaining claim blocks"),
    ScrollResizeConflict("That outline overlaps another claim or doesn't fit its parent or subdivisions. Scroll back or left-click to cancel."),
    ScrollResizeNotEnoughBlocks("You need {0} more claim blocks for that. Scroll back or left-click to cancel.", "0: missing claim blocks"),
    ScrollResizeLimit("That side can't move any further."),
    ScrollResizeNoSegment("Look at a side of the shaped section you're standing in."),
    ScrollResizeCancelled("Scroll resize cancelled."),
    ScrollResizeTimedOut("Scroll resize cancelled after a minute without scrolling."),
    ScrollResizeUnchanged("Scroll resize closed without changes."),
    ScrollResizeClaimGone("That claim no longer exists."),
    ShapedSubdivisionNoParent("Right-click inside a claim you can edit to start a shaped subdivision."),
    ShapedSubdivisionOutsideParent("Shaped subdivisions have to stay inside the claim you're subdividing."),
    ShapedSubdivisionOn3DClaim("Shaped subdivisions only work inside top-level 2D claims."),
    ShapedSubdivisionSuccess("Shaped subdivision created."),
    ShapedSubdivisionReshaped("Shaped subdivision updated."),
    ...
    ClaimLabel("claim", "Used as {0} in messages for main claims"),
    SubdivisionLabel("subdivision", "Used as {0} in messages for subdivisions"),
    ConfirmPvpToggleEnabledNoFee("Do you want to enable PvP in this {0}?", "0: claim type label"),
    ConfirmPvpToggleDisabledNoFee("Do you want to disable PvP in this {0}?", "0: claim type label"),
    ConfirmPvpToggleEnabledWithFee("Do you want to pay {0} to enable PvP in this {1}?", "0: Vault-formatted fee; 1: claim type label"),
    ConfirmPvpToggleDisabledWithFee("Do you want to pay {0} to disable PvP in this {1}?", "0: Vault-formatted fee; 1: claim type label"),
    PvPToggleEnabled("PvP enabled in this {0}.", "0: claim type label"),
    PvPToggleDisabled("PvP disabled in this {0}.", "0: claim type label"),
    PvPToggleEnabledWithFee("PvP enabled in this {0} for {1}.", "0: claim type label; 1: Vault-formatted fee"),
    PvPToggleDisabledWithFee("PvP disabled in this {0} for {1}.", "0: claim type label; 1: Vault-formatted fee"),
    ...
    ConfirmPvpToggleInstruction("Type /claim pvp {0} confirm or /claimpvpconfirm to confirm.", "0: true or false"),
    PvpToggleUsage("Usage: /claim pvp [true|false|on|off] [confirm]"),
    PvpToggleAlreadyEnabled("PvP is already enabled in this {0}.", "0: claim type label"),
    PvpToggleAlreadyDisabled("PvP is already disabled in this {0}.", "0: claim type label"),
    ConfirmPvPToggleNoFee("Do you want to enable PvP in this {0}?"),
    ConfirmPvPToggleWithFee("Do you want to pay {0} to enable PvP in this {1}?"),
    ...
    NonSiegeWorld("Siege is disabled here."),
    AlreadySieging("You're already involved in a siege."),
    NotSiegableThere("{0} isn't protected there.", "0: defending player"),
    SiegeTooFarAway("You're too far away to siege."),
    NoSiegeYourself("You cannot siege yourself."),
    NoSiegeDefenseless("That player is defenseless.  Go pick on somebody else."),
    AlreadyUnderSiegePlayer("{0} is already under siege.  Join the party!", "0: defending player"),
    AlreadyUnderSiegeArea("That area is already under siege.  Join the party!"),
    NoSiegeAdminClaim("Siege is disabled in this area."),
    SiegeOnCooldown("You're still on siege cooldown for this defender or claim.  Find another victim."),
    SiegeAlert("You're under siege!  If you log out now, you will die.  You must defeat {0}, wait for them to give up, or escape.", "0: attacker name"),
    SiegeConfirmed("The siege has begun!  If you log out now, you will die.  You must defeat {0}, chase them away, or walk away.", "0: defender name"),
    ...
    NeighborPermission("bypass minimum distance"),
    PvPTrustPermission("fight players"),
    PvETrustPermission("fight animals"),
    ...
    SiegeNoDrop("You can't give away items while involved in a siege."),
    ...
    SiegeNoTeleport("You can't teleport out of a besieged area."),
    BesiegedNoTeleport("You can't teleport into a besieged area."),
    SiegeNoContainers("You can't access containers while involved in a siege."),
    ...
    SiegeNoShovel("You can't use your shovel tool while involved in a siege."),
    ...
    SiegeWinDoorsOpen("Congratulations!  Buttons and levers are temporarily unlocked."),
    RescueAbortedMoved("You moved!  Rescue cancelled."),
    SiegeDoorsLockedEjection("Looting time is up!  Ejected from the claim."),
    NoModifyDuringSiege("Claims can't be modified while under siege."),
    ...
    NoBuildUnderSiege("This claim is under siege by {0}.  No one can build here.", "0: attacker name"),
    NonSiegeMaterial("That material is too tough to break."),
    NoOwnerBuildUnderSiege("You can't make changes while under siege."),
    ...
    NoPvPTrust("You don't have {0}'s permission to fight players here.", "0: owner name.  pvp trust controls combat against players in claims"),
    NoPvETrust("You don't have {0}'s permission to fight animals here.", "0: owner name.  pve trust controls combat against creatures in claims"),
    NoContainersSiege("This claim is under siege by {0}.  No one can access containers here right now.", "0: attacker name"),
    ...
    CommandInvalidMode("Invalid mode. Valid options: basic, 2d, 3d, shaped"),
    ...
    MaxBonusReached("Can't purchase {0} more claim blocks. The server has a limit of {1} bonus claim blocks.", "0: requested blocks; 1: bonus block limit"),
    CantGrantThatPermission("You can't grant a permission you don't have yourself."),
    SiegeImmune("That player is immune to /siege."),
    ...
    PlaceholderTrustLevelNeighbor("Neighbor", "Returned by %gp3d_trust_level% when the player has neighbor trust in the claim and is within the minimum distance radius."),
    ...
    CreateClaimFailTooClose("You can't create a claim here because it's too close to {0}'s claim. Minimum distance is {1} blocks.", "0: owner name; 1: minimum distance"),
    CreateClaimFailTooCloseNoBypass("You can't create a claim here because it's too close to another claim. Minimum distance is {0} blocks.", "0: minimum distance"),
    MinimumDistance("Minimum distance between claims: {0} blocks.", "0: minimum distance"),
    NearbyClaims("Nearby claims: {0}", "0: number of nearby claims"),
    DistanceCheckEnabled("Distance check enabled. You will be warned when creating claims too close to others."),
    DistanceCheckDisabled("Distance check disabled."),
    NeighborTrustGranted("Granted {0} neighbor trust. They can now bypass minimum distance checks for your claims.", "0: player name"),
    NeighborTrustRevoked("Revoked {0}'s neighbor trust.", "0: player name"),
    NeighborTrustGrantedAll("Granted {0} neighbor trust for ALL your claims.", "0: player name"),
