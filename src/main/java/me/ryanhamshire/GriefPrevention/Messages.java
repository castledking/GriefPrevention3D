...
public enum Messages
{
    ...
    PvPToggleEnable("enable"),
    PvPToggleDisable("disable"),
    ConfirmPvpToggleNoFee("Do you want to {0} PvP in this {1}?", "0: enable/disable; 1: Claim/Subdivision"),
    ConfirmPvpToggleWithFee("Do you want to pay {0} to {1} PvP in this {2}?", "0: fee; 1: enable/disable; 2: Claim/Subdivision"),
    PvPToggleSuccess("PvP {0} in this {1}.", "0: enabled/disabled; 1: Claim/Subdivision"),
    PvPToggleSuccessWithFee("PvP {0} in this {1} for {2}.", "0: enabled/disabled; 1: Claim/Subdivision; 2: fee"),
    ...
    ConfirmPvPToggleNoFee("Do you want to {0} PvP in this {1}?"),
    ConfirmPvPToggleWithFee("Do you want to pay {0} to {1} PvP in this {2}?"),
