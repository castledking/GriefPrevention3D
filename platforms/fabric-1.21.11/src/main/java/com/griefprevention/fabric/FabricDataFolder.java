...
final class FabricDataFolder
{
    ...
    private static final String DEFAULT_MESSAGES = """
            ...
            Messages:
              ...
              PvpToggleUsage: "Usage: /claimpvp [true|false|on|off] [confirm]"
              ...
              ConfirmPvpToggleInstruction: "Type /claimpvp {0} confirm to confirm."
              ...
              PvPToggleEnabledWithFee: "PvP enabled in this {0}. Fee charged: {1}."
              PvPToggleDisabledWithFee: "PvP disabled in this {0}. Fee charged: {1}."
              PvPToggleEnabled: "PvP enabled in this {0}."
              PvPToggleDisabled: "PvP disabled in this {0}."
              ClaimLabel: "claim"
              SubdivisionLabel: "subdivision"
              NoPermissionForCommand: "You don't have permission to use this command."
            """;
